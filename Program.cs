...
names[0] = "Kate is tall";
names[1] = "Jack is short";

names[2] = "Rebecca is sad";
names[3] = "Tom is profound"; 

string[] names2 = new[] { "Kate :)", "Jack :D", "Rebecca :(", "Tom :O" };
...
string[,] grid1 = new[,] // two dimensions
{
  ...
  { "Anne 5", "Ben 6", "Charlie 7", "Doug 8" },
  
  { "Aardvark 9", "Bear 10", "Cat 11", "Dog 12" }
};
